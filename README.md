...
- Управление головой с ИК-пульта (пульт направляем на голову, направление соответствует пользователю):
  - `LEFT` / `RIGHT` - поворот головы влево/вправо относительно пользователя
  - `UP` / `DOWN` - наклон вверх/вниз
  - Диагональные кнопки для комбинированных движений
- Глаза следуют за выбранным направлением
...
- `MODE1 (1)` — Злость (сдвинутые брови + тряска головы + звук)
- `MODE2 (2)` — Грусть (опущенная голова + грустные глаза + звук)
- `MODE3 (3)` — Сердечки (сердца на глазах + мягкое покачивание + мелодия)

Расширенный набор эмоций (переключение `BLUE` или стрелками):
- Удивление (широкие глаза + быстрый подъём головы + звук)
- Сонливость (полуприкрытые глаза + плавное опускание головы + спокойный звук)
- Остальные эмоции из списка выше
...
### Сердечки (Love)
- Изображение: сердечки
- Анимация: мягкое моргание сердечками
- Звук: плавная «романтичная» мелодия
- Движение: лёгкие кивки и покачивания головы

### Сонливость (Sleepy)
- Изображение: полуприкрытые глаза
- Анимация: спокойное удержание с небольшими покачиваниями
- Звук: убаюкивающая мелодия
- Движение: плавное опускание головы с лёгкой «дремотой»

## Инструкция эксплуатации

1. Включите робота (`POWER`). Пульт держите направленным на голову, направления кнопок соответствуют вашему положению перед роботом.
2. В режиме управления головой перемещайте голову стрелками; диагонали дают комбинированные наклоны.
3. Перейдите в режим эмоций (`RED`):
   - Быстрые эмоции по кнопкам: `GREEN` — радость, `1` — злость, `2` — грусть, `3` — сердечки.
   - Дополнительные эмоции листайте `BLUE` или стрелками: удивление, сонливость и другие.
4. Для возвращения к управлению головой нажмите `RED` ещё раз. Голова и взгляд вернутся в центр.
